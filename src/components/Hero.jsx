      ...
      <div className="relative min-h-screen flex flex-col justify-between p-8 ">
        <header className="relative z-20 pt-4" id="logo">
          <div className="flex items-center gap-4">
            <img
              src="src/images/tax-orchard-logo.svg"
        ...
        <main className="relative z-20 text-center flex-grow flex flex-col justify-center items-center py-8">
          <h2
            id="main-title"
            className="text-6xl md:text-[218px] font-black tracking-normal leading-none font-schabo mb-6 cursor-pointer hover:opacity-80 transition-opacity duration-300"
          >
            TAX ORCHARD
          </h2>
          <p
            className="text-xl md:text-[40px] font-proxima-regular font-semibold"
