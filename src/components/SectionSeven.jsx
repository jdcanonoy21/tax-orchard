...
export default function SectionSeven() {
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    // // Flip to next page when scroll progress <= 0.5 and not already flipped
    // if (latest >= 0.45 && !flipped) {
    ...
    console.log("Section scroll progress:", latest);
  });

  return (
    <section
      className="min-h-screen bg-black w-screen overflow-hidden relative"
    ...
    >
      ...
      >
        ...
        <div
          ...
          className="calendar-section min-h-screen bg-white !w-full flex items-center justify-center relative z-50 pt-10"
        >
              ...
              <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 sm:px-8 md:px-12 lg:px-16 relative">
                <div className="text-center w-3/4 justify-center items-center mb-8 sm:mb-12">
                  <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-proxima-regular !leading-[1.3] text-black ">
                    ...
                    with your financial advisor and $500,000 into your Tax
                    Orchard seed account.
                  </p>
                </div>
          ...
          <div className="w-full max-w-7xl mx-auto relative border border-gray-500  overflow-hidden -ml-[45%]">
            <div className="relative">
              <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 sm:px-8 md:px-12 lg:px-16 relative">
                <div className="text-center justify-center items-center mb-8 sm:mb-12 w-3/4">
                  <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-proxima-regular !leading-[1.3] text-black ">
                    Tax Orchard actively manages this process, applying benefits
