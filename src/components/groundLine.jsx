...
export default function GroundLine({sectionRef}) {
    /* === STATES ===== */
    ...
    return (
       <div className="relative w-full mb-8 flex justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 9.557" width="100%" height="100%" className="w-full md:w-[60%] h-auto rotate-[0.5deg]" preserveAspectRatio="xMidYMid meet">
            <defs>
            <clipPath id="clip-path">
                <rect id="Rectangle_874" data-name="Rectangle 874" width="100%" height="100%" fill="none"/>
            </clipPath>
            ...
            <g id="Ground" transform="translate(50%, 0)">
